              ...
              <Figure>
                ...
                <Modal show={showImage} onHide={handleCloseimage}>
                  ...
                  <Form.Group controlId="formFile" className="mb-3">
                    ...
                    <Form.Control type="file" ref={fileRefAvatar} onChange={(e) => setFileAvatar(e.target.files[0])} />
              ...
              <Figure>
                ...
                <Modal show={showImage} onHide={handleCloseimage}>
                  ...
                  <Form.Group controlId="formFile" className="mb-3">
                    ...
                    <Form.Control type="file" ref={fileRefImage} onChange={(e) => setFileImage(e.target.files[0])} />
                    <div className="d-grid gap-2">
